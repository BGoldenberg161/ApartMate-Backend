...
// .then passthrough for each of the userIDs, run a db.user.find({_id: venmo.userId} function
// let venmoHandle = user.venmo
// venmo://paycharge?txn=pay&recipients=duffl&amount=6.96&note=UCLA.DUFFL.COM:%2010%20minute%20delivery%20%23BIOALI
